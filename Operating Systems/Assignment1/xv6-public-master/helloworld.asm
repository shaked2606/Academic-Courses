...
printint(int fd, int xx, int base, int sgn)
{
 ...
 37f:	f7 f6                	div    %esi
 381:	0f b6 92 18 07 00 00 	movzbl 0x718(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 4f8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 4fb:	b8 11 07 00 00       	mov    $0x711,%eax
...
free(void *ap)
{
 ...
 581:	a1 b0 09 00 00       	mov    0x9b0,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 5fa:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 5fd:	a3 b0 09 00 00       	mov    %eax,0x9b0
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 619:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 61c:	8b 15 b0 09 00 00    	mov    0x9b0,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 66f:	76 3f                	jbe    6b0 <malloc+0xa0>
    ...
    if(p == freep)
 671:	39 05 b0 09 00 00    	cmp    %eax,0x9b0
 ...
 67e:	53                   	push   %ebx
 67f:	e8 7e fc ff ff       	call   302 <sbrk>
  if(p == (char*)-1)
 ...
 696:	e8 e5 fe ff ff       	call   580 <free>
  return freep;
 69b:	8b 15 b0 09 00 00    	mov    0x9b0,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 6bc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 6bf:	89 15 b0 09 00 00    	mov    %edx,0x9b0
      return (void*)(p + 1);
 ...
 6d4:	eb e9                	jmp    6bf <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6d6:	c7 05 b0 09 00 00 b4 	movl   $0x9b4,0x9b0
 6dd:	09 00 00 
 6e0:	c7 05 b4 09 00 00 b4 	movl   $0x9b4,0x9b4
 6e7:	09 00 00 
    base.s.size = 0;
 6ea:	b8 b4 09 00 00       	mov    $0x9b4,%eax
 6ef:	c7 05 b8 09 00 00 00 	movl   $0x0,0x9b8
 6f6:	00 00 00 
