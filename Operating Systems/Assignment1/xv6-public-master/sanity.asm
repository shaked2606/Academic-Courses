...
int main(int argc, char *argv[])
{
  ...
  11:	68 64 08 00 00       	push   $0x864
  16:	6a 01                	push   $0x1
  18:	e8 13 05 00 00       	call   530 <printf>
	int pid1 = fork();
  1d:	e8 98 03 00 00       	call   3ba <fork>
	if(pid1 == 0){
  22:	83 c4 10             	add    $0x10,%esp
  25:	85 c0                	test   %eax,%eax
  27:	75 1c                	jne    45 <main+0x45>
		test(getpid(),10, 3);
  29:	e8 14 04 00 00       	call   442 <getpid>
  2e:	52                   	push   %edx
  2f:	6a 03                	push   $0x3
  31:	6a 0a                	push   $0xa
  33:	50                   	push   %eax
  34:	e8 d7 00 00 00       	call   110 <test>
		exit(0);
  39:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  40:	e8 7d 03 00 00       	call   3c2 <exit>
	}
	else{
		int pid2 = fork();
  45:	e8 70 03 00 00       	call   3ba <fork>
		if(pid2 == 0){
  4a:	85 c0                	test   %eax,%eax
  4c:	75 1c                	jne    6a <main+0x6a>
			test(getpid(), 5, 2);
  ...
  56:	6a 05                	push   $0x5
  58:	50                   	push   %eax
  59:	e8 b2 00 00 00       	call   110 <test>
			exit(0);
  5e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  65:	e8 58 03 00 00       	call   3c2 <exit>
		}
		else{
			int pid3 = fork();
  6a:	e8 4b 03 00 00       	call   3ba <fork>
			if(pid3 == 0){
  6f:	85 c0                	test   %eax,%eax
  71:	75 1c                	jne    8f <main+0x8f>
				test(getpid(), 1, 1);
  73:	e8 ca 03 00 00       	call   442 <getpid>
  78:	52                   	push   %edx
  79:	6a 01                	push   $0x1
  7b:	6a 01                	push   $0x1
  7d:	50                   	push   %eax
  7e:	e8 8d 00 00 00       	call   110 <test>
				exit(0);
  83:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8a:	e8 33 03 00 00       	call   3c2 <exit>
			}
			else{
				wait(&status1);
  ...
  95:	50                   	push   %eax
  96:	e8 2f 03 00 00       	call   3ca <wait>
				wait(&status2);
  9b:	8d 45 f0             	lea    -0x10(%ebp),%eax
  9e:	89 04 24             	mov    %eax,(%esp)
  a1:	e8 24 03 00 00       	call   3ca <wait>
				wait(&status3);
  a6:	8d 45 f4             	lea    -0xc(%ebp),%eax
  a9:	89 04 24             	mov    %eax,(%esp)
  ac:	e8 19 03 00 00       	call   3ca <wait>
			}
		}
	}
	exit(0);
  b1:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  b8:	e8 05 03 00 00       	call   3c2 <exit>
  bd:	66 90                	xchg   %ax,%ax
  bf:	90                   	nop
...
{ 
  ...
  cf:	7e 2e                	jle    ff <fib+0x3f>
  d1:	89 fb                	mov    %edi,%ebx
  d3:	31 f6                	xor    %esi,%esi
  d5:	8d 76 00             	lea    0x0(%esi),%esi
        return n; 
    return fib(n-1) + fib(n-2); 
  d8:	8d 43 ff             	lea    -0x1(%ebx),%eax
  db:	83 ec 0c             	sub    $0xc,%esp
  de:	83 eb 02             	sub    $0x2,%ebx
  e1:	50                   	push   %eax
  e2:	e8 d9 ff ff ff       	call   c0 <fib>
  e7:	83 c4 10             	add    $0x10,%esp
  ea:	01 c6                	add    %eax,%esi
#include "user.h"
#include "perf.h"
...
{ 
    if (n <= 1) 
  ec:	83 fb 01             	cmp    $0x1,%ebx
  ef:	7f e7                	jg     d8 <fib+0x18>
  f1:	83 e7 01             	and    $0x1,%edi
        return n; 
    return fib(n-1) + fib(n-2); 
} 
  f4:	8d 65 f4             	lea    -0xc(%ebp),%esp
  f7:	8d 04 37             	lea    (%edi,%esi,1),%eax
  fa:	5b                   	pop    %ebx
  fb:	5e                   	pop    %esi
  fc:	5f                   	pop    %edi
  fd:	5d                   	pop    %ebp
...
void test(int pid, int ps_priority, int cfs_priority){
 ...
 113:	83 ec 24             	sub    $0x24,%esp
	struct perf performance;
	// int i = 10000000;
	// int dummy = 0;
	set_ps_priority(ps_priority);
 116:	ff 75 0c             	pushl  0xc(%ebp)
 119:	e8 5c 03 00 00       	call   47a <set_ps_priority>
	set_cfs_priority(cfs_priority);
 11e:	58                   	pop    %eax
 11f:	ff 75 10             	pushl  0x10(%ebp)
 122:	e8 4b 03 00 00       	call   472 <set_cfs_priority>
 127:	83 c4 10             	add    $0x10,%esp
 12a:	ba 27 00 00 00       	mov    $0x27,%edx
 12f:	90                   	nop
...
{ 
 ...
 133:	52                   	push   %edx
 134:	e8 87 ff ff ff       	call   c0 <fib>
 139:	83 ea 02             	sub    $0x2,%edx
...
{ 
    if (n <= 1) 
 13f:	83 fa ff             	cmp    $0xffffffff,%edx
 142:	75 ec                	jne    130 <test+0x20>
	set_cfs_priority(cfs_priority);
	// while(i--){
	// 	dummy+=i;
	// }
 ...
 144:	8d 45 e8             	lea    -0x18(%ebp),%eax
 147:	83 ec 0c             	sub    $0xc,%esp
 14a:	50                   	push   %eax
 14b:	e8 32 03 00 00       	call   482 <proc_info>
	printf(1,"%d		%d		%d		%d		%d\n",
 150:	83 c4 0c             	add    $0xc,%esp
 153:	ff 75 f4             	pushl  -0xc(%ebp)
 156:	ff 75 f0             	pushl  -0x10(%ebp)
 159:	ff 75 ec             	pushl  -0x14(%ebp)
 15c:	ff 75 e8             	pushl  -0x18(%ebp)
 15f:	ff 75 08             	pushl  0x8(%ebp)
 162:	68 50 08 00 00       	push   $0x850
 167:	6a 01                	push   $0x1
 169:	e8 c2 03 00 00       	call   530 <printf>
	pid, performance.ps_priority, performance.stime, performance.retime, performance.rtime);
}
 16e:	83 c4 20             	add    $0x20,%esp
 171:	c9                   	leave  
 172:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4cf:	f7 f6                	div    %esi
 4d1:	0f b6 92 b0 08 00 00 	movzbl 0x8b0(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 648:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 64b:	b8 a8 08 00 00       	mov    $0x8a8,%eax
...
free(void *ap)
{
 ...
 727:	89 08                	mov    %ecx,(%eax)
  freep = p;
 729:	a3 98 0b 00 00       	mov    %eax,0xb98
}
 72e:	5b                   	pop    %ebx
 72f:	5e                   	pop    %esi
 730:	5f                   	pop    %edi
 ...
 74a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 74d:	a3 98 0b 00 00       	mov    %eax,0xb98
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 7bf:	76 3f                	jbe    800 <malloc+0xa0>
    ...
    if(p == freep)
 7c1:	39 05 98 0b 00 00    	cmp    %eax,0xb98
 ...
 7e6:	e8 e5 fe ff ff       	call   6d0 <free>
  return freep;
 7eb:	8b 15 98 0b 00 00    	mov    0xb98,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 80c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 80f:	89 15 98 0b 00 00    	mov    %edx,0xb98
      return (void*)(p + 1);
 ...
 824:	eb e9                	jmp    80f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 826:	c7 05 98 0b 00 00 9c 	movl   $0xb9c,0xb98
 82d:	0b 00 00 
 830:	c7 05 9c 0b 00 00 9c 	movl   $0xb9c,0xb9c
 837:	0b 00 00 
    base.s.size = 0;
