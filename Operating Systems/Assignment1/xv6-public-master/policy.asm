...
int main(int argc, char *argv[])
{
  ...
  18:	e8 43 02 00 00       	call   260 <atoi>
	switch (policynum)
...
int main(int argc, char *argv[])
{
  ...
  23:	89 c3                	mov    %eax,%ebx
	switch (policynum)
  25:	74 55                	je     7c <main+0x7c>
  27:	83 f8 02             	cmp    $0x2,%eax
  2a:	74 3d                	je     69 <main+0x69>
  2c:	85 c0                	test   %eax,%eax
  2e:	74 26                	je     56 <main+0x56>
		break;
	case 2:
  ...
  30:	50                   	push   %eax
  31:	53                   	push   %ebx
  32:	68 08 08 00 00       	push   $0x808
  37:	6a 01                	push   $0x1
  39:	e8 02 04 00 00       	call   440 <printf>
		break;
  ...
  44:	53                   	push   %ebx
  45:	e8 30 03 00 00       	call   37a <policy>
  	exit(0);
  4a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  51:	e8 7c 02 00 00       	call   2d2 <exit>
{
	int policynum = atoi(argv[1]);
	switch (policynum)
	{
  ...
  56:	50                   	push   %eax
  57:	50                   	push   %eax
  58:	68 60 07 00 00       	push   $0x760
  5d:	6a 01                	push   $0x1
  5f:	e8 dc 03 00 00       	call   440 <printf>
		break;
  64:	83 c4 10             	add    $0x10,%esp
  67:	eb d8                	jmp    41 <main+0x41>
	case 1:
  ...
  69:	52                   	push   %edx
  6a:	52                   	push   %edx
  6b:	68 d4 07 00 00       	push   $0x7d4
  70:	6a 01                	push   $0x1
  72:	e8 c9 03 00 00       	call   440 <printf>
		break;
  77:	83 c4 10             	add    $0x10,%esp
  7a:	eb c5                	jmp    41 <main+0x41>
	{
	case 0:
		printf(1, "Policy has been successfully changed to Default Policy\n");
		break;
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3df:	f7 f6                	div    %esi
 3e1:	0f b6 92 48 08 00 00 	movzbl 0x848(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 558:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 55b:	b8 40 08 00 00       	mov    $0x840,%eax
