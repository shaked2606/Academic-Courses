...
int main(int argc, char *argv[])
{
   ...
   f:	e8 56 03 00 00       	call   36a <memsize>
  14:	83 ec 04             	sub    $0x4,%esp
  17:	50                   	push   %eax
  18:	68 70 07 00 00       	push   $0x770
  1d:	6a 01                	push   $0x1
  1f:	e8 2c 04 00 00       	call   450 <printf>
	char* x = (char*) malloc(2000);
  24:	c7 04 24 d0 07 00 00 	movl   $0x7d0,(%esp)
  2b:	e8 50 06 00 00       	call   680 <malloc>
  30:	89 c3                	mov    %eax,%ebx
	printf(1, "Allocating more memory\n");
  32:	58                   	pop    %eax
  33:	5a                   	pop    %edx
  34:	68 8a 07 00 00       	push   $0x78a
  39:	6a 01                	push   $0x1
  3b:	e8 10 04 00 00       	call   450 <printf>
	printf(1, "The process is using: %d\n", memsize());
  40:	e8 25 03 00 00       	call   36a <memsize>
  45:	83 c4 0c             	add    $0xc,%esp
  48:	50                   	push   %eax
  49:	68 70 07 00 00       	push   $0x770
  4e:	6a 01                	push   $0x1
  50:	e8 fb 03 00 00       	call   450 <printf>
	free(x);
  55:	89 1c 24             	mov    %ebx,(%esp)
  58:	e8 93 05 00 00       	call   5f0 <free>
	printf(1, "Freeing memory\n");
  5d:	59                   	pop    %ecx
  5e:	5b                   	pop    %ebx
  5f:	68 a2 07 00 00       	push   $0x7a2
  64:	6a 01                	push   $0x1
  66:	e8 e5 03 00 00       	call   450 <printf>
	printf(1, "The process is using: %d\n", memsize());
  6b:	e8 fa 02 00 00       	call   36a <memsize>
  ...
  87:	e8 06 03 00 00       	call   392 <set_cfs_priority>
	exit(0);
...
putc(int fd, char c)
{
 ...
 568:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 56b:	b8 b2 07 00 00       	mov    $0x7b2,%eax
