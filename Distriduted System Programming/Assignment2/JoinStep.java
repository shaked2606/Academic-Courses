...
public class JoinStep {
    ...
    public JoinStep(String jarName, String mainClassName, String stepConfigName, String inputDir1, String inputDir2, String outputDir) {
    ...
    public StepConfig configJarStep(){
        HadoopJarStepConfig hadoopJarStep = new HadoopJarStepConfig()
                ...
                .withArgs("s3n://jarwordcount/" + this.inputDir1, "s3n://jarwordcount/" + this.inputDir2, "s3n://jarwordcount/" + this.outputDir);
