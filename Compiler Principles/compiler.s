...
%define MAKE_BOOL(bool) MAKE_SIMPLE_LITERAL T_BOOL, db bool

%define MAKE_FLOAT(r,val) MAKE_LONG_VALUE r, val, T_FLOAT
%define MAKE_LITERAL_FLOAT(fl) MAKE_SIMPLE_LITERAL T_FLOAT, dq fl

%define MAKE_CHAR(r,val) MAKE_CHAR_VALUE r, val
%define MAKE_LITERAL_CHAR(ch) MAKE_SIMPLE_LITERAL T_CHAR, db ch

%define MAKE_LITERAL_SYMBOL(sym) MAKE_SIMPLE_LITERAL T_SYMBOL, dq sym
