...
public class Join2 {
    ...
    public static class tripletsMapper extends Mapper<LongWritable, Text, Text, Text> {
        ...
        protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
            ...
            String word12 = split_triplets[0] + " "+ split_triplets[1];
            String word23 = split_triplets[1] + " " +  split_triplets[2];

            context.write(new Text(word12), new Text("triplets" + " " + split_triplets[0] +" " + split_triplets[1] + " " +split_triplets[2] + " c2" ));
            context.write(new Text(word23), new Text("triplets" + " " + split_triplets[0] +" " + split_triplets[1] + " " +split_triplets[2] + " n2" ));
        }
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        MultipleInputs.addInputPath(job, new Path(args[0]), TextInputFormat.class,pairsMapper.class);
