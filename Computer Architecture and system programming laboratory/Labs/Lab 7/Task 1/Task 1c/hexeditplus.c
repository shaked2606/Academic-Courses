...
int main(int argc, char **argv) {
	...
	int action = 0;
	char option[128];
	struct fun_desc menu[] = {{"Toggle Debug Mode",toggleDebugMode}, {"Set File Name",setFileName},{"Set Unit Size",setUnitSize},{"Load Into Memory",LoadIntoMmemory},{"Memory Display",memoryDisplay},{"Save Into File", saveIntoFile},{"Quit",quit}, {"NULL",NULL}};
